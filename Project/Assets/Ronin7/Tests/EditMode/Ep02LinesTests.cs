...
{
    public class Ep02LinesTests
    {
        // Every speaker used in Ep02Lines must appear here AND have an exact-match entry in
        ...
        private static readonly HashSet<string> KnownCast = new HashSet<string>
        {
            ...
            "Saffron Veil Enforcer 1",
            "Saffron Veil Enforcer 2",
            "Saffron Veil Enforcer 3",
            "Saffron Veil Guard 1",
            "Saffron Veil Guard 2",
            "Saffron Veil Guard 3",
            "Saffron Veil Guard 4",
            "Gilded Maw Handler 1",
            "Gilded Maw Handler 2",
            "Veil Escort 1",
            "Dominion Enforcer 1",
            "Dominion Enforcer 2",
        };
        ...
        {
            foreach (string setId in Ep02Lines.SetIds)
            {
                var lines = Ep02Lines.Get(setId);
        ...
        public void ClipNames_AreUniqueAcrossAllSets()
        {
            ...
            foreach (string setId in Ep02Lines.SetIds)
            {
                ...
                for (int i = 0; i < lines.Length; i++)
                {
                    string clip = Ep02Lines.ClipName(setId, i, lines[i].speaker);
        ...
        {
            Assert.AreEqual(0, Ep02Lines.Get("not_a_real_set").Length);
        }
    }
}
